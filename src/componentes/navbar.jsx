...
const NavBar = () => {
    ...
    return (<nav id="navBar" className="navbar navbar-dark navbar-1 bg-dark d-flex overflow-hidden">
            ...
            <div class="col-sm-10 px-3 d-flex justify-content-start"><a className="navbar-brand" href="#">CompuShop</a></div>

            <div class="col-sm-1 p-1"><CartWidget className="" color="light" /></div>
