        ...
        return (
            <div className='d-flex flex-column align-items-center'>
                ...
                <div className='d-flex flex-column align-items-center w-100'>
                    ...
                    <Link className='col-6 col-sm-3 ' to="/computers"><button onClick={postSubmit} className='w-100 bg-light border border-primary rounded text-primary'>Home</button></Link>
                </div>
